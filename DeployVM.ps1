...
$vm = "Test2" # name of VM, this just applies in Windows, it isn't applied to the OS guest itself.
$image = "E:\ubuntu-20.04.3-live-server-amd64.iso"
$vmswitch = "SWITCH" # name of your local vswitch
$port = "port2" # port on the VM
$vlan = 199 # VLAN that VM traffic will be send in
$cpu =  2 # Number of CPUs
$ram = 2GB # RAM of VM. Note this is not a string, not in quotation marks
$path_to_disk = "E:\" # Where you want the VM's virtual disk to reside
$disk_size = 60GB # VM storage, again, not a string
